...
void search(int n_pts,
			...
			// char* query_data, char* base_data, char* path_gt, char* path_index){
	int real_topk = topk;
	topk = 100;
	...
	std::string base_data = fmt::format("{}/{}.ds", kFrontPath, kDataset);
	fmt::println("data path: {}", base_data);
	...
	std::string query_data = fmt::format("{}/{}.q", kFrontPath, kDataset);
